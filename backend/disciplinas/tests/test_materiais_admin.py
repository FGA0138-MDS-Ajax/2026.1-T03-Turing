...
class MaterialTestCaseAdmin(APITestCase):
    ...
    def test_Post_material_imagem(self):
    ...
    def test_Post_material_apresentacao(self):
    ...
    def test_Post_material_documento(self):
        arquivo = SimpleUploadedFile(
            'arquivo.docx',
            b'docx',
    ...
    def test_Post_material_link(self):
        data = {
            "nome": "material link",
            "tipo": "link",
            "conteudo": 1,
    ...
    def test_Post_material_video(self):
        data = {
            "nome": "material video",
            "tipo": "video",
            "conteudo": 1,
